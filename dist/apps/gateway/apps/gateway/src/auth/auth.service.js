...
const utils_provider_1 = require("../../../../libs/providers/utils.provider");
...
let AuthService = class AuthService {
    ...
    async validateUser(userLoginDto) {
        ...
        const isPasswordValid = await utils_provider_1.UtilsProvider.validateHash(userLoginDto.password, user === null || user === void 0 ? void 0 : user.password);
