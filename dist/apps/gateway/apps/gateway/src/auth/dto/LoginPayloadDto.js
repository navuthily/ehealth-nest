...
let LoginPayloadDto = class LoginPayloadDto {
...
__decorate([
    (0, swagger_1.ApiProperty)({ type: TokenPayloadDto_1.TokenPayloadDto }),
    (0, graphql_1.Field)({ nullable: true }),
    __metadata("design:type", TokenPayloadDto_1.TokenPayloadDto)
], LoginPayloadDto.prototype, "token", void 0);
LoginPayloadDto = __decorate([
    (0, graphql_1.ObjectType)('LoginPayloadDto'),
    __metadata("design:paramtypes", [user_dto_1.UserDto, TokenPayloadDto_1.TokenPayloadDto])
], LoginPayloadDto);
