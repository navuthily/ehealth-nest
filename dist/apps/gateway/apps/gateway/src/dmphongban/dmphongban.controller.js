...
exports.DmphongbanController = void 0;
...
const dmphongban_entity_1 = require("./dmphongban.entity");
const dmphongban_service_1 = require("./dmphongban.service");
let DmphongbanController = class DmphongbanController {
    constructor(service) {
        this.service = service;
    }
};
DmphongbanController = __decorate([
    (0, crud_1.Crud)({
        model: {
            type: dmphongban_entity_1.DmphongbanEntity,
        },
        routes: {
            deleteOneBase: {
    ...
    (0, common_1.Controller)('dmphongban'),
    (0, common_1.UseGuards)((0, auth_guard_1.AuthGuard)(), roles_guard_1.RolesGuard),
    (0, swagger_1.ApiBearerAuth)(),
    (0, swagger_1.ApiTags)('dmphongban'),
    (0, common_1.UsePipes)(new common_1.ValidationPipe()),
    __metadata("design:paramtypes", [dmphongban_service_1.DmphongbanService])
], DmphongbanController);
exports.DmphongbanController = DmphongbanController;
//# sourceMappingURL=dmphongban.controller.js.map