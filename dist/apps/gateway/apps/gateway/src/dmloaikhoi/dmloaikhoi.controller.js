...
exports.DmloaikhoiController = void 0;
...
const dmloaikhoi_entity_1 = require("./dmloaikhoi.entity");
let DmloaikhoiController = class DmloaikhoiController {
    constructor(service) {
        this.service = service;
    }
};
DmloaikhoiController = __decorate([
    (0, crud_1.Crud)({
        model: {
            type: dmloaikhoi_entity_1.DmloaikhoiEntity,
        },
        routes: {
            deleteOneBase: {
    ...
    (0, common_1.Controller)('dmloaikhoi'),
    (0, common_1.UseGuards)((0, auth_guard_1.AuthGuard)(), roles_guard_1.RolesGuard),
    (0, swagger_1.ApiBearerAuth)(),
    (0, swagger_1.ApiTags)('dmloaikhoi'),
    (0, common_1.UsePipes)(new common_1.ValidationPipe()),
    __metadata("design:paramtypes", [dmloaikhoi_service_1.DmloaikhoiService])
], DmloaikhoiController);
exports.DmloaikhoiController = DmloaikhoiController;
//# sourceMappingURL=dmloaikhoi.controller.js.map