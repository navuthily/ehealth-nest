...
let ChuyenkhoaController = class ChuyenkhoaController {
    constructor(service) {
        this.service = service;
    }
};
ChuyenkhoaController = __decorate([
    (0, crud_1.Crud)({
        model: {
            type: chuyenkhoa_entity_1.ChuyenkhoaEntity,
        },
        routes: {
            deleteOneBase: {
    ...
    (0, common_1.Controller)('chuyenkhoa'),
    (0, common_1.UseGuards)((0, auth_guard_1.AuthGuard)(), roles_guard_1.RolesGuard),
    (0, swagger_1.ApiBearerAuth)(),
    (0, swagger_1.ApiTags)('chuyenkhoa'),
    (0, common_1.UsePipes)(new common_1.ValidationPipe()),
    __metadata("design:paramtypes", [chuyenkhoa_service_1.ChuyenkhoaService])
], ChuyenkhoaController);
exports.ChuyenkhoaController = ChuyenkhoaController;
//# sourceMappingURL=chuyenkhoa.controller.js.map