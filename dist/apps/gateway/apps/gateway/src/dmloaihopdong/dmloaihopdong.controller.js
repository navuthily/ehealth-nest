...
exports.DmloaihopdongController = void 0;
...
let DmloaihopdongController = class DmloaihopdongController {
    constructor(service) {
        this.service = service;
    }
};
DmloaihopdongController = __decorate([
    (0, crud_1.Crud)({
        model: {
            type: dmloaihopdong_entity_1.DmloaihopdongEntity,
        },
        routes: {
            deleteOneBase: {
    ...
    (0, common_1.Controller)('dmloaihopdong'),
    (0, common_1.UseGuards)((0, auth_guard_1.AuthGuard)(), roles_guard_1.RolesGuard),
    (0, swagger_1.ApiBearerAuth)(),
    (0, swagger_1.ApiTags)('dmloaihopdong'),
    (0, common_1.UsePipes)(new common_1.ValidationPipe()),
    __metadata("design:paramtypes", [dmloaihopdong_service_1.DmloaihopdongService])
], DmloaihopdongController);
exports.DmloaihopdongController = DmloaihopdongController;
//# sourceMappingURL=dmloaihopdong.controller.js.map