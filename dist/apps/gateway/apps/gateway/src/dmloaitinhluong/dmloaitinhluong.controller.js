...
exports.DmloaitinhluongController = void 0;
...
let DmloaitinhluongController = class DmloaitinhluongController {
    constructor(service) {
        this.service = service;
    }
};
DmloaitinhluongController = __decorate([
    (0, crud_1.Crud)({
        model: {
            type: dmloaitinhluong_entity_1.DmloaitinhluongEntity,
        },
        routes: {
            deleteOneBase: {
    ...
    (0, common_1.Controller)('dmloaitinhluong'),
    (0, common_1.UseGuards)((0, auth_guard_1.AuthGuard)(), roles_guard_1.RolesGuard),
    (0, swagger_1.ApiBearerAuth)(),
    (0, swagger_1.ApiTags)('dmloaitinhluong'),
    (0, common_1.UsePipes)(new common_1.ValidationPipe()),
    __metadata("design:paramtypes", [dmloaitinhluong_service_1.DmloaitinhluongService])
], DmloaitinhluongController);
exports.DmloaitinhluongController = DmloaitinhluongController;
//# sourceMappingURL=dmloaitinhluong.controller.js.map