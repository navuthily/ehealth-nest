...
exports.DmbophanController = void 0;
...
const dmbophan_entity_1 = require("./dmbophan.entity");
const dmbophan_service_1 = require("./dmbophan.service");
const auth_guard_1 = require("../../../../libs/guards/auth.guard");
let DmbophanController = class DmbophanController {
    constructor(service) {
        this.service = service;
    }
};
DmbophanController = __decorate([
    (0, crud_1.Crud)({
        model: {
            type: dmbophan_entity_1.DmbophanEntity,
        },
        query: {
            join: {
                phongban: {
    ...
    (0, common_1.Controller)('dmbophan'),
    (0, common_1.UseGuards)((0, auth_guard_1.AuthGuard)(), roles_guard_1.RolesGuard),
    (0, swagger_1.ApiBearerAuth)(),
    (0, swagger_1.ApiTags)('dmbophan'),
    (0, common_1.UsePipes)(new common_1.ValidationPipe()),
    __metadata("design:paramtypes", [dmbophan_service_1.DmbophanService])
], DmbophanController);
exports.DmbophanController = DmbophanController;
//# sourceMappingURL=dmbophan.controller.js.map